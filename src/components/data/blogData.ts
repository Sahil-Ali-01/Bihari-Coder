const blogData = [
  {
    ...
    slug: "#https://example.com/build-restful-api-nodejs-express"
  },
  {
    ...
    slug: "https://example.com/mastering-react-hooks-useeffect"
  },
  {
    ...
    slug: "https://example.com/css-grid-vs-flexbox"
  },
  {
    ...
    slug: "https://example.com/authentication-best-practices"
  },
  {
    ...
    slug: "https://example.com/typescript-react-getting-started"
  },
  {
    ...
    slug: "https://example.com/responsive-design-patterns"
  },
  {
    title: "JPG, JPEG, PNG to PDF Converter",
    excerpt: "Learn how to convert JPG, JPEG, and PNG images to PDF format using various online tools and software.",
    date: "May 15, 2025",
    readTime: "5 min read",
    category: "Project",
